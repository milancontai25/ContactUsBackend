...
const StoreProductDetail = () => {
  // Extract only itemSlug from the URL
  ...
  const handleBuyNow = async () => {
    ...
    try {
        ...
        // 2. Instantly navigate to checkout for just this item (UPDATED PATH)
  ...
  return (
    <div className="product-detail-page elegant-theme">
      ...
      {/* UPDATED: Removed slug prop to match CartDrawer changes */}
