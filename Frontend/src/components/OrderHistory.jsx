...
const ordersArray = Array.isArray(fetchedData) 
    ? fetchedData 
    : (fetchedData.results || fetchedData.orders || fetchedData.data || []);
    ...
    <div className="history-page">
      <div className="history-container">
        <div className="history-header">
           {/* UPDATED: Path points to root instead of /slug */}
           <Link to="/marketplace" className="back-link"><ArrowLeft size={18}/> Back to Store</Link>
           <h1>My Orders</h1>
        </div>
