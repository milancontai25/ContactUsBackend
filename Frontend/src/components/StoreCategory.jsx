...
const StoreCategory = () => {
  ...
  // Sends the shopper to the shop page with the matching collection pre-applied
  const goToCollection = (collection) => {
    navigate(`/marketplace/items?collection=${collection}`);
  };
  ...
  // The header submits the search itself (Enter or the icon), so there is no
  // navigate-on-every-keystroke effect here any more.
          ...
          <div className="elegant-main-wrapper">
            ...
            <div className="category-blocks-grid">
              {summaryData.categories.map((cat, idx) => (
                <Link
                  to={`/marketplace/items?category=${encodeURIComponent(cat.category)}`}
                  key={idx}
                  className="cat-block"
                >
      ...
      {summaryData.best_selling.length > 0 && (
        <section className="elegant-section section-white">
          <div className="elegant-main-wrapper">
            ...
            <ScrollRow className="srow--products" ariaLabel="best selling products">
            ...
            <div className="see-more-row">
              <button
                ...
                onClick={() => goToCollection('best_selling')}
              >
          ...
          <div className="elegant-main-wrapper">
            ...
            <div className="see-more-row">
              <button
                type="button"
                className="btn-see-more"
                onClick={() => goToCollection('trending')}
              >
